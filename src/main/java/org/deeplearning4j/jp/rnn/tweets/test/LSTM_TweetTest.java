package org.deeplearning4j.jp.rnn.tweets.test;
...
public class LSTM_TweetTest {
	...
	private static CharacterIterator getShakespeareIterator(int miniBatchSize, int exampleLength, int examplesPerEpoch) throws Exception{
		...
		String fileLocation = "/tmp/foo.txt"; //tempDir + "/Shakespeare.txt";	//Storage location from downloaded file
