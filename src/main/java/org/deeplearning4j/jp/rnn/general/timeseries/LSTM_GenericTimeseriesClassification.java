package org.deeplearning4j.jp.rnn.general.timeseries;
...
/**
 * TODO
 * 	1. generate a few fake timeseries w labels (fraud, no-fraud)
 * 	2. setup the network
 * 	3. set the data load of the timeseries into the network .fit() method
 * 	4. output a report on how accurate the model is
 * 
 * @author josh
 *
 */
public class LSTM_GenericTimeseriesClassification {
	...
	private static CharacterIterator getShakespeareIterator(int miniBatchSize, int exampleLength, int examplesPerEpoch) throws Exception{
		...
		String fileLocation = "src/main/resources/rnn_sammer.txt"; //tempDir + "/Shakespeare.txt";	//Storage location from downloaded file
