package org.deeplearning4j.examples.rnn.synthetic.simple2;
...
public class Synthetic_Simple2_LSTM_Model {
	...
	public static void trainExample() throws Exception {
		...
		Simple2Dataset_Iterator iter = new Simple2Dataset_Iterator("src/test/resources/data/synthetic/simple_2/simple_2_data.txt", "src/test/resources/data/synthetic/simple_2/simple_2_labels.txt", miniBatchSize, totalExamplesToTrainWith);
		
		//SyntheticDataIterator test_iter = getPhysioNetIterator( miniBatchSize, 1000 );
		Simple2Dataset_Iterator test_iter = new Simple2Dataset_Iterator("src/test/resources/data/synthetic/simple_2/simple_2_data.txt", "src/test/resources/data/synthetic/simple_2/simple_2_labels.txt", miniBatchSize, totalExamplesToTrainWith);
