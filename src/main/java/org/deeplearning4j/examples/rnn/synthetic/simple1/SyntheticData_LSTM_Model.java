...
public class SyntheticData_LSTM_Model {
	...
	public static void trainExample() throws Exception {
		...
		SyntheticDataIterator test_iter = new SyntheticDataIterator("src/test/resources/data/synthetic/simple/simple_ts_data", "", 40, 40);
